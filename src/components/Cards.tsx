  ...
  Education: [
    {
      ...
      description:
        "I am currently studying Engineering Science at the University of Toronto and will graduate in 2025 with a specialty in Robotics and a minor in Business and AI. Noteworthy Achievements:",
      bulletPoints: [
        ...
        "Noteworthy courses: CSC384H1: Introduction to Artificial Intelligence, ROB301H1: Introduction to Robotics, MAT292H1: Ordinary Differential Equations, ROB310H1: Mathematics for Robotics, ECE286H1: Probability and Statistics, CSC263H1: Data Structures and Analysis",
      ],
